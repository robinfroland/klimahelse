...
import com.example.helse.parsedAirqualityResponse
...
class AirqualityForecastApiTest {
    ...
    fun fetchAirquality() {
        ...
        assertEquals(parsedAirqualityResponse, response.parseAirqualityResponse(selectedLocation)[0])
